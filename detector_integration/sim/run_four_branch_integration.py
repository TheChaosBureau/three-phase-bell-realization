...
from detector_integration.detectors.closure_latch import first_event_latch, post_click_closure_placeholder
...
def run_four_branch_trials(
    ...
    """
    Return exact four-branch weights, empirical frequencies, correlator, and errors.
    """
    ...
    for _ in range(n_trials):
        ...
        winner = first_event_latch(event_times)
