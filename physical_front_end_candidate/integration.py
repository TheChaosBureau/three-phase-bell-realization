...
from .export_interface import PhysicalEnvelopeConfig, detector_export_from_power, resolve_envelope_config
...
def run_two_branch_physical_handoff(
    ...
    *,
    ...
    export_config = resolve_envelope_config(candidate["envelope_config"])
    detector_envelopes = detector_export_from_power(candidate["branch_power_w"], branch_labels=branch_labels, envelope_config=export_config)
